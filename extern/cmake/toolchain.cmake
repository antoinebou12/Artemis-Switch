...
function(gen_dksh romfs_dir)
    ...
    if (ENABLE_UPSCALING)
        ...
        execute_process(COMMAND ${NX_UAM_EXE} -s frag -o "${romfs_dir}/sgsr1_fsh.dksh" "${CMAKE_CURRENT_SOURCE_DIR}/app/src/streaming/video/deko3d/sgsr1_fsh.glsl" TIMEOUT 5)
        execute_process(COMMAND ${NX_UAM_EXE} -s frag -o "${romfs_dir}/nis_fsh.dksh" "${CMAKE_CURRENT_SOURCE_DIR}/app/src/streaming/video/deko3d/nis_fsh.glsl" TIMEOUT 5)
    endif ()
endfunction()
