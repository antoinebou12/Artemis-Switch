...
class OptionsTab : public brls::Box {
  ...
  private:
    ...
    BRLS_BIND(brls::BooleanCell, optionsRememberZoomPan, "options_remember_zoom_pan");
    BRLS_BIND(brls::Header, zoomHeader, "zoom_header");
    BRLS_BIND(brls::Slider, zoomSlider, "options_zoom_slider");
    BRLS_BIND(brls::Header, panXHeader, "pan_x_header");
    BRLS_BIND(brls::Slider, panXSlider, "options_pan_x_slider");
    BRLS_BIND(brls::Header, panYHeader, "pan_y_header");
    BRLS_BIND(brls::Slider, panYSlider, "options_pan_y_slider");
