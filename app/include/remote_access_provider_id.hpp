...
inline std::string toString(RemoteAccessProviderId id) {
    switch (id) {
        ...
        case RemoteAccessProviderId::Tailscale: return "Tailscale";
    }
    return "Off";
}
...
inline RemoteAccessProviderId fromInt(int v) {
    switch (v) {
        ...
        case 4: return RemoteAccessProviderId::Tailscale;
...
inline RemoteAccessProviderId providerFromSelectorIndex(int selection) {
    switch (selection) {
        ...
        case 1: return RemoteAccessProviderId::WireGuard;
        case 2: return RemoteAccessProviderId::NetBird;
        case 3: return RemoteAccessProviderId::Tailscale;
        default: return RemoteAccessProviderId::Off;
    }
}
...
inline int selectorIndexFromProvider(RemoteAccessProviderId provider) {
    switch (provider) {
        case RemoteAccessProviderId::Off: return 0;
        case RemoteAccessProviderId::WireGuard: return 1;
        case RemoteAccessProviderId::NetBird: return 2;
        case RemoteAccessProviderId::Tailscale: return 3;
    }
    return 0;
}
